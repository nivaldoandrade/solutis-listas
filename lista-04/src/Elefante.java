public class Elefante extends AnimalTerrestreAB {
    ...
    public void comer() {
        qtdComidaIngerida += 1;
        System.out.printf("O Elefante comeu a quantidade: %d%n", qtdComidaIngerida);
    }

    @Override
    public void moverse() {
        qtdCaminhoPercorrido += 10;
        System.out.printf("O Elefante percorreu a quantidade: %d%n", qtdCaminhoPercorrido);
    }

    @Override
    public void dormir() {
        qtdHorasDormida += 8;
        System.out.printf("O Elefante dormiu a quantidade: %d %n", qtdHorasDormida);
    }
}
